...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="font-size">Manggar Manding</h2>

    <div class="slides">
      <img src="/Project/src/assets/images/RESTAURANT/MANGGAR MANDING/1.jpg" alt="" />
      <img src="/Project/src/assets/images/RESTAURANT/MANGGAR MANDING/2.jpg" alt="" />
      <img src="/Project/src/assets/images/RESTAURANT/MANGGAR MANDING/3.jpg" alt="" />
    </div>
    <h2 class="font-size-cat">Daftar Menu</h2>
    <div class="card-one">
      <div class="box-one">
        <p>Motor: 258 hp/400 Nm</p>
        <p>Cylinder/cubic capacity: 4/1,998 cc</p>
        <p>Doors/Seats: 4/5</p>
      </div>
      <div class="box-one">
    ...
    <div class="card-one">
      <div class="box-one">
        <p>Mall Kuningan City, Jl. Prof. DR. Satrio No.18, Kuningan, Kecamatan Setiabudi, Daerah Khusus Ibukota Jakarta 12940</p>
      </div>
    </div>
